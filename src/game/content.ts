...
export const REGIONS: Record<RegionId, RegionDefinition> = {
  root_halls: {
    id: 'root_halls', name: 'The Root Halls', subtitle: 'Vines, old stone, and the first relic seals.',
    pressureLabel: 'Stable · surge every 9 moves', surgeEvery: 9, width: 11, height: 9,
    start: { x: 1, y: 7 }, exit: { x: 9, y: 1 }, nextRegion: 'sunken_archive',
    ...
    walls: [...border(11, 9), { x: 3, y: 1 }, { x: 3, y: 2 }, { x: 3, y: 4 }, { x: 3, y: 5 }, { x: 5, y: 4 }, { x: 6, y: 4 }, { x: 7, y: 4 }, { x: 8, y: 2 }, { x: 8, y: 3 }, { x: 1, y: 5 }, { x: 2, y: 5 }],
    palette: { floorA: 0x294b35, floorB: 0x24422f, wall: 0x18251d, accent: 0xd9bd72 }
  },
  sunken_archive: {
    id: 'sunken_archive', name: 'The Sunken Archive', subtitle: 'Flooded records and unstable cultivation chambers.',
    pressureLabel: 'Unstable · surge every 7 moves', surgeEvery: 7, width: 11, height: 9,
    start: { x: 1, y: 1 }, exit: { x: 9, y: 7 }, nextRegion: 'vault_heart',
    relics: [{ x: 5, y: 1 }, { x: 8, y: 5 }],
    hazards: [{ x: 3, y: 2 }, { x: 6, y: 6 }, { x: 8, y: 2 }, { x: 4, y: 5 }],
    wardCaches: [{ x: 2, y: 6 }],
    toolCaches: [{ x: 4, y: 1 }],
    guardians: [{ x: 5, y: 5 }, { x: 8, y: 6 }],
    checkpoints: [{ x: 5, y: 4 }],
    walls: [...border(11, 9), { x: 2, y: 3 }, { x: 3, y: 3 }, { x: 4, y: 3 }, { x: 6, y: 2 }, { x: 6, y: 3 }, { x: 6, y: 4 }, { x: 2, y: 7 }, { x: 3, y: 7 }, { x: 7, y: 5 }, { x: 7, y: 6 }],
